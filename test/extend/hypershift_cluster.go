...
func ValidHypershiftAndGetGuestKubeConf(oc *util.CLI) (string, string, string) {
	/*if IsROSA() {
...
func ValidHypershiftAndGetGuestKubeConfWithNoSkip(oc *util.CLI) (string, string, string) {
	/*if IsROSA() {
		e2e.Logf("there is a ROSA env")
...
func GetHyperShiftOperatorNameSpace(oc *util.CLI) string {
	args := []string{
		"pods", "-A",
...
func GetHyperShiftHostedClusterNameSpace(oc *util.CLI) string {
...
func GetHostedClusterPlatformType(oc *util.CLI, clusterName, clusterNamespace string) (HostedClusterPlatformType, error) {
...
func GetNodePoolNamesbyHostedClusterName(oc *util.CLI, hostedClusterName, hostedClusterNS string) []string {
...
func GetHostedClusterVersion(mgmtOc *util.CLI, hostedClusterName, hostedClusterNs string) semver.Version {
...
func CheckHypershiftOperatorExistence(mgmtOC *util.CLI) (bool, error) {
...
func SkipOnHypershiftOperatorExistence(mgmtOC *util.CLI, expectHO bool) {
...
func IsHypershiftHostedCluster(oc *util.CLI) bool {
